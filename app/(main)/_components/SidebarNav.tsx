    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
        >
          <ChevronsLeft className="h-6 w-6" aria-label="close sidebar" />
        </div>
        <div>
          <UserItem />
        ...
        <div
          className="opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize absolute w-1 h-full bg-primary/10 right-0 top-0"
